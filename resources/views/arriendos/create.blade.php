        ...
        <form method="POST" action="{{route('arriendos.store')}}">
            ...
            <div class="row">
                ...
                <div class="col-6 my-2">
                    ...
                    <input type="text" id="dia_arriendo" name="dia_arriendo" placeholder="Dia Arriendo: "
                        class="form-control">
                </div>

                <div class="col-6 my-2">
                    <label for="dia-entrega" class="form-label">Dia Entrega: </label>
                    <input type="text" id="dia_entrega" name="dia_entrega" placeholder="Dia Entrega: "
                        class="form-control">
                </div>

                <div class="col-12 my-2">
                    <label for="total-pago" class="form-label">Total: </label>
                    <input type="text" id="total_pago" name="total_pago" placeholder="Total a Pagar: "
                        class="form-control">
                </div>
