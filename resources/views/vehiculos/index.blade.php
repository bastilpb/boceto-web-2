        ...
        <div class="col-4 my-2">
            <div class="card rounded">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Tipo de combustible: Bencina.<br>Rendimiento: 15<em>[km]/Lt.</em><br>Costo: $33.000<em>/dia.</em></p>
        ...
        <div class="col-4 my-2">
            <div class="card rounded">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Tipo de combustible: Bencina.<br>Rendimiento: 20.5<em>[km]/Lt.</em><br>Costo: $29.000<em>/dia.</em></p>
                    <a href="#" class="btn btn-primary">Arrendar!</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-4 my-2">
            <div class="card rounded">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Tipo de combustible: Bencina.<br>Rendimiento: 14.6<em>[km]/Lt.</em><br>Costo: $41.000<em>/dia.</em></p>
                    <a href="#" class="btn btn-primary">Arrendar!</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-4 my-2">
            <div class="card rounded">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Tipo de combustible: Bencina.<br>Rendimiento: 9.6<em>[km]/Lt.</em><br>Costo: $54.0O0<em>/dia.</em></p>
                    <a href="#" class="btn btn-primary">Arrendar!</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-4 my-2">
            <div class="card rounded">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Tipo de combustible: Bencina.<br>Rendimiento: 10.5<em>[km]/Lt.</em><br>Costo: $83.000<em>/dia.</em></p>
                    <a href="#" class="btn btn-primary">Arrendar!</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-4 my-2">
            <div class="card rounded">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Tipo de combustible: Bencina.<br>Rendimiento: 7<em>[km]/Lt.</em><br>Costo: $64.000<em>/dia.</em></p>
                    <a href="#" class="btn btn-primary">Arrendar!</a>
                </div>
            </div>
        </div>
